/*!   GeneXus C# 16_0_9-140712 on 6/15/2020 9:43:55.3
*/
...
gx.define('wwpbaseobjects.managefilters', false, function () {
   ...
   this.GridgridstatecollectionsContainer = new gx.grid.grid(this, 2,"WbpLvl2",15,"Gridgridstatecollections","Gridgridstatecollections","GridgridstatecollectionsContainer",this.CmpContext,this.IsMasterPage,"wwpbaseobjects.managefilters",[],false,1,false,true,0,true,false,false,"CollWWPBaseObjects\GridStateCollection.Item",0,"px",0,"px","Novo registro",true,false,false,null,null,false,"AV7GridStateCollection",false,[1,1,1,1],false,0,true,false);
   var GridgridstatecollectionsContainer = this.GridgridstatecollectionsContainer;
   GridgridstatecollectionsContainer.addSingleLineEdit("Moveup",16,"vMOVEUP","","","MoveUp","char",30,"px",20,20,"left","e140y2_client",[],"Moveup","MoveUp",true,0,false,false,"Attribute",1,"WWIconActionColumn");
   GridgridstatecollectionsContainer.addSingleLineEdit("Movedown",17,"vMOVEDOWN","","","MoveDown","char",30,"px",20,20,"left","e150y2_client",[],"Movedown","MoveDown",true,0,false,false,"Attribute",1,"WWIconActionColumn");
   ...
   GridgridstatecollectionsContainer.addSingleLineEdit("Udelete",20,"vUDELETE","","","UDelete","char",30,"px",20,20,"left","e160y2_client",[],"Udelete","UDelete",true,0,false,false,"Attribute",1,"WWIconActionColumn");
   ...
   GXValidFnc[18]={ id:18 ,lvl:2,type:"svchar",len:100,dec:0,sign:false,ro:0,isacc:0,grid:15,gxgrid:this.GridgridstatecollectionsContainer,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"GRIDSTATECOLLECTION__TITLE",gxz:"ZV22GXV2",gxold:"OV22GXV2",gxvar:"GXV2",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",inputType:'text',autoCorrect:"1",v2v:function(Value){if(Value!==undefined)gx.O.GXV2=Value},v2z:function(Value){if(Value!==undefined)gx.O.ZV22GXV2=Value},v2c:function(row){gx.fn.setGridControlValue("GRIDSTATECOLLECTION__TITLE",row || gx.fn.currentGridRowImpl(15),gx.O.GXV2,0)},c2v:function(row){if(this.val(row)!==undefined)gx.O.GXV2=this.val(row)},val:function(row){return gx.fn.getGridControlValue("GRIDSTATECOLLECTION__TITLE",row || gx.fn.currentGridRowImpl(15))},nac:gx.falseFn};
   GXValidFnc[19]={ id:19 ,lvl:2,type:"vchar",len:2097152,dec:0,sign:false,ro:0,isacc:0,grid:15,gxgrid:this.GridgridstatecollectionsContainer,fnc:null,isvalid:null,evt_cvc:null,evt_cvcing:null,rgrid:[],fld:"GRIDSTATECOLLECTION__GRIDSTATEXML",gxz:"ZV23GXV3",gxold:"OV23GXV3",gxvar:"GXV3",ucs:[],op:[],ip:[],nacdep:[],ctrltype:"edit",inputType:'text',autoCorrect:"1",v2v:function(Value){if(Value!==undefined)gx.O.GXV3=Value},v2z:function(Value){if(Value!==undefined)gx.O.ZV23GXV3=Value},v2c:function(row){gx.fn.setGridControlValue("GRIDSTATECOLLECTION__GRIDSTATEXML",row || gx.fn.currentGridRowImpl(15),gx.O.GXV3,0)},c2v:function(row){if(this.val(row)!==undefined)gx.O.GXV3=this.val(row)},val:function(row){return gx.fn.getGridControlValue("GRIDSTATECOLLECTION__GRIDSTATEXML",row || gx.fn.currentGridRowImpl(15))},nac:gx.falseFn};
   ...
   GXValidFnc[25]={ id: 25, fld:"BTNENTER",grid:0,evt:"e110y2_client",std:"ENTER"};
   GXValidFnc[26]={ id: 26, fld:"",grid:0};
   GXValidFnc[27]={ id: 27, fld:"BTNCANCEL",grid:0,evt:"e170y1_client"};
   ...
   this.Events = {"e110y2_client": ["ENTER", true] ,"e140y2_client": ["VMOVEUP.CLICK", true] ,"e150y2_client": ["VMOVEDOWN.CLICK", true] ,"e160y2_client": ["VUDELETE.CLICK", true] ,"e170y1_client": ["CANCEL", true]};
