/*!   GeneXus C# 16_0_9-140712 on 6/15/2020 9:43:53.10
*/
...
gx.define('wwpbaseobjects.savefilteras', false, function () {
   ...
   GXValidFnc[14]={ id: 14, fld:"TEXTBLOCKFILTERNAME", format:0,grid:0};
   ...
   GXValidFnc[20]={ id: 20, fld:"BTNENTER",grid:0,evt:"e120x2_client",std:"ENTER"};
   GXValidFnc[21]={ id: 21, fld:"BTNCANCEL",grid:0,evt:"e140x1_client"};
   this.AV8FilterName = "" ;
   this.ZV8FilterName = "" ;
   this.OV8FilterName = "" ;
   this.AV8FilterName = "" ;
   ...
   this.Events = {"e120x2_client": ["ENTER", true] ,"e140x1_client": ["CANCEL", true]};
